...
function generateDailyPost() {
  ...
  // Calculate differences for display in parentheses (change from yesterday)
  const cashDiff = current1500.averages.cashPercentage - prev1500.averages.cashPercentage;
  ...
  const riskDiff = current1500.averages.riskScore - prev1500.averages.riskScore;
  ...
  const gainDiff = current1500.averages.gain - prev1500.averages.gain;
  ...
  const winRatioDiff = current1500.averages.winRatio - prev1500.averages.winRatio;
